...
export default function OrderedReport(p) {
  ...
  return (
    <div>
      <NavBarGoGo />
      <Link to={'/order-history'} className='backLink'>
              ...
              <div className='col-xl-8'>
                <div className='card shadow'>
                  <div className='card-header bg-light font-weight-bold text-gray-800 text-center'>
                    REPORT REGARDING ORDERED ITEMS
                  </div>
      ...
      <div style={{ paddingTop: '30px', paddingBottom: '30px' }}>
        <button className='reportbtn btn btn-dark' onClick={() => window.print()}>
          Print
        </button>
      </div>
    </div>
