...
function ViewCart() {
  ...
  const onAddItem = async (Image, ItemName, Description, Price) => {
    try {
      ...
      const response = await axios.post(`${API_URL}/favorites/add`, item);
  ...
  const finalTotal = async () => {
    ...
    try {
      const response = await axios.get(`${API_URL}/cart/get/${id}`);
      const responseItem = await axios.get(`${API_URL}/storeAdmin/`);
                ...
                <MDBRow className='g-0'>
                  <MDBCol lg='12'>
                    <div className='p-5'>
                      <div>
                        <MDBTypography>
                          <Link to={'/userHome'} className='backLink'>
                          ...
                          <MDBRow className='mb-4 d-flex justify-content-between align-items-center'>
                            ...
                            <MDBCol md='3' lg='3' xl='2' className='d-flex align-items-center'>
                              <MDBInput
                                type='number'
                                min='1'
                                defaultValue={cartItem.orderedQuanity}
                                size='sm'
                                ...
                                onChange={async (e) => {
                                  try {
                                    ...
                                    await axios.post(
                                      `http://localhost:5050/cart/update/${cartItem._id}`,
                                      data
                                    );
                                  } catch (error) {
                                    alert(error);
